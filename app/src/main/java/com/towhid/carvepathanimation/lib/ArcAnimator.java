package com.towhid.carvepathanimation.lib;
...
public class ArcAnimator extends Animator {
    ...
    public static ArcAnimator createArcAnimator(View clipView, View nestView,
        ...
        return createArcAnimator(clipView, Utils.centerX(nestView), 100,
                degree, side);
    }
    ...
    public static ArcAnimator createArcAnimator(View clipView,float startX,float startY, float endX, float endY,
                                                float degree, Side side) {

        ArcMetric arcMetric = ArcMetric.evaluate(startX, startY,
                endX, endY, degree, side);
        return new ArcAnimator(arcMetric, clipView);
    }
